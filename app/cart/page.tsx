    ...
    return(
        <div className="lg:flex p-5">
            ...
            <div className=" bg-[#F7F7F7] p-8 llg:h-[62.89px)] lg:pl-10">
                ...
                <p className="font-normal text-[#111] font-poppins text-[11px] leading-6">Applies to orders of ₹ 14 000.00 or more. <span className="pl-3"><u>View details</u></span></p>
            </div>
            <div>
                ...
                <div className="lg:flex p-5">
                <div className="lg:w-1/4"><Image src="/images/Frame.png" alt="product" width={150} height={150} /></div>
                <div className="px-10 lg:w-1/2"><h2 className="font-medium text-[15px] leading-7 text-[#111] font-poppins">Nike Air Max 97 SE</h2>
                    ...
                    <div className="flex"><WishlistIcon/><Image src="/images/delete1.png" alt="icon" width={30} height={5}/></div>
                    </div>
                    <div className="lg:w-1/4"><span className="font-normal text-[15px] leading-7 text-right font-poppins">MRP: ₹ 3 895.00</span></div>
                </div>
            </div>
            ...
            <span className="text-[15px] leading-7 font-poppins font-normal text-[#757575]"> 20 890.00</span></div>
            <Link href="/checkout"><button className="title-font sm:text-2xl md:text-[15px] leading-6 font-medium text-white w-full h-16 rounded-[30px] bg-[#111] px-[7.5px]  pl-[21.5px] pr-[20.69px]">
            Member Checkout
          </button></Link>
            </div>
       </div>
